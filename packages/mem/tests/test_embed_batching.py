...
from mem.core import Mem
from mem.embeddings.utils import batched_embed
...
# -- Integration test: Mem._embed_and_store with fake embedder --
...
def mem_with_fake(tmp_path: Path):
    """Mem instance wired to a FakeEmbedder with batch_size=4."""

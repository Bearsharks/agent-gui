...
_PROVIDERS: dict[str, tuple[str, str]] = {
    ...
    "google": ("mem.embeddings.google", "GoogleEmbedding"),
    "voyage": ("mem.embeddings.voyage", "VoyageEmbedding"),
    "jina": ("mem.embeddings.jina", "JinaEmbedding"),
    "mistral": ("mem.embeddings.mistral", "MistralEmbedding"),
    "ollama": ("mem.embeddings.ollama", "OllamaEmbedding"),
    "local": ("mem.embeddings.local", "LocalEmbedding"),
    "onnx": ("mem.embeddings.onnx", "OnnxEmbedding"),
}
...
_INSTALL_HINTS: dict[str, str] = {
    "openai": "pip install mem  (or: uv add mem)",
    "google": 'pip install "mem[google]"  (or: uv add "mem[google]")',
    "voyage": 'pip install "mem[voyage]"  (or: uv add "mem[voyage]")',
    "jina": 'pip install "mem[jina]"  (or: uv add "mem[jina]")',
    "mistral": 'pip install "mem[mistral]"  (or: uv add "mem[mistral]")',
    "ollama": 'pip install "mem[ollama]"  (or: uv add "mem[ollama]")',
    "local": 'pip install "mem[local]"  (or: uv add "mem[local]")',
    "onnx": 'pip install "mem[onnx]"  (or: uv add "mem[onnx]")',
}
